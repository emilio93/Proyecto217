...
\begin{center}
    \includegraphics[width=\textwidth]{./AAUgraphics/clase1.png}
\end{center}
\end{frame}

\begin{frame}{Diagrama de Clases}
\begin{center}
    \includegraphics[width=0.65\textwidth]{./AAUgraphics/clase2.png}
\end{center}
\end{frame}

\begin{frame}{Diagrama de Clases}
\begin{center}
    \includegraphics[width=0.9\textwidth]{./AAUgraphics/clase3.png}
\end{center}
\end{frame}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.40\textwidth]{./AAUgraphics/sql.png}
%\caption{ \scriptsize }
\end{figure}

...
class IPeriodo {
    public:
         ...
         */
        virtual bool mayorDuracion(IPeriodo);

        /**
         * @breif Indica si un periodo es menor en duración con
         *        respecto al otro periodo.
         */
        virtual bool menorDuracion(IPeriodo);
         ...
         */
        virtual bool traslapa(IPeriodo);
};
